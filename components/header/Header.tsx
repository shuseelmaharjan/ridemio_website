...
export default function Header() {
  ...
  // ✅ Solid header when:
  // - NOT home (always solid)
  // - home + scrolled
  // - home + menu open (hover)
  ...
  // ✅ Only track scroll on homepage (other pages always solid anyway)
  React.useEffect(() => {
    if (!isHome) {
      setScrolled(false);
      return;
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden md:block">
            ...
            >
              ...
              {menuOpen && (
                <div
                  className="fixed left-0 top-16 z-[9999] w-screen bg-white pb-8 shadow-lg animate-fade-in duration-300"
                  onMouseEnter={() => {
                    clearCloseTimer();
                    setMenuOpen(true);
                  }}
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button
                  ...
                  size="icon"
                  className={[
                    "h-10 w-10 rounded-xl border-none transition",
                    headerSolid
              ...
              <SheetContent side="right" className="w-2/3 max-w-sm sm:max-w-md">
                {/* Sheet Header */}
